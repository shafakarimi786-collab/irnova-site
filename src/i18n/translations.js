...
export const ui = {
  en: {
    ...
    novaServer: {
      ...
      specs: [
        { k: 'Protocols', v: '10 + Reality' },
        { k: 'Transports', v: '6 + XHTTP' },
        { k: 'Fleet', v: 'Multi-node' },
        { k: 'Security', v: '2FA + login guard' },
        { k: 'Panel', v: 'EN / FA / RU' },
      ],
      ...
      groups: [
        ...
        },
        {
          ...
          items: [
            ...
            'DNS tunnel for when only DNS resolves: MasterDnsVPN or CottenDns',
        ...
        },
        {
          ...
          items: [
            ...
            'Token-authed REST API and outbound webhooks',
            'Multi-admin with reseller roles',
            'Two-factor auth (Google Authenticator)',
            'Login guard that blocks repeated failed sign-ins',
  ...
  fa: {
    ...
    novaServer: {
      ...
      specs: [
        { k: 'پروتکل‌ها', v: '۱۰ + Reality' },
        { k: 'ترنسپورت‌ها', v: '۶ + XHTTP' },
        { k: 'ناوگان', v: 'چندنودی' },
        { k: 'امنیت', v: 'دومرحله‌ای + نگهبان ورود' },
        { k: 'پنل', v: 'EN / FA / RU' },
      ],
      ...
      groups: [
        ...
        },
        {
          ...
          items: [
            ...
            'تونل DNS برای وقتی که فقط DNS جواب می‌دهد: MasterDnsVPN یا CottenDns',
        ...
        },
        {
          ...
          items: [
            ...
            'REST API با احراز توکن و وب‌هوک خروجی',
            'چند مدیر با نقش‌های نمایندگی',
            'ورود دومرحله‌ای (Google Authenticator)',
            'نگهبان ورود که تلاش‌های ناموفق پیاپی را مسدود می‌کند',
